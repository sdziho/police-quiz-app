...
function HomeCard({data, title}) {
  ...
  const categoryObject =
    title === 'Kategorije' || title === 'Zakoni' || title === 'Test';
  ...
  useEffect(() => {
    ...
    switch (title) {
      ...
      case 'Zakoni':
        ...
        break;
      case 'Test':
        setSelectedChild(<CategoriesList isTestSelected={true} />);
        break;
      case 'Aktuelni konkursi':
        ...
        break;
      default:
        setSelectedChild(<Text>DEFAULT</Text>);
    }
  ...
  return (
    <View>
      <View style={styles.container}>
        ...
        {!swipableObject && (
          <TouchableOpacity style={[styles.oneElement, styles.shadowBox]}>
            <ImageBackground source={image} style={styles.backgroundImage}>
